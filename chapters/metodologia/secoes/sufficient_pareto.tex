...
\begin{figure}[ht]
    \caption{
        Conceptual illustration of sufficient values for auxiliary rewards. The sufficient value of the auxiliary reward is $30$.
    }
    \centering
    \includegraphics[width=\linewidth]{images/suff_pareto.pdf}
