...
\textbf{Theoretical Background} introduces the foundational concepts of Reinforcement Learning.
...
\textbf{Experimental Setup} introduces the relevant frameworks for building training environments, as well as summarizes the environmental protocol to evaluate the proposed framework.
