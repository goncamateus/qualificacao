\section{Q-\textit{Decomposition}}
\label{sec:decompq}

\citeonline{russell2003q} represents a foundational contribution to both \gls{morl} and to the present work, as it introduced the \textbf{Q-\textit{decomposition}} method. This approach demonstrated that it is possible to learn Q-value components independently and still converge to policies that are comparable to—or even better than—those learned through standard single-objective methods.
